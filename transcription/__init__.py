...
class CurrentState(str, Enum):
    """string enum for transcription pipeline states"""
    RECEIVED = "received"
...
__all__ = ["generate_diarized_transcript"]